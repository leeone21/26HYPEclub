...
import Lp2Shell, { useLpCta } from "@/app/lp2/_components/Lp2Shell";

/**
 * LP-M — 메타(인스타·페이스북) 광고 전용 랜딩. 내용은 /lp2와 완전히 동일하다.
 * 주소를 따로 두는 이유: /lp2는 당근이 쓰고 있어, 같은 주소를 메타까지 공유하면
 * UTM 파라미터에만 의존해 채널을 구분해야 한다. UTM은 인앱 브라우저에서 유실될 수
 * 있고, 예약 전환율도 채널별로 자동 집계되지 않는다. 주소를 나누면 기존 variant
 * 기반 집계(방문·예약·전환율)를 그대로 재사용해 더 단단하게 구분된다.
 */
